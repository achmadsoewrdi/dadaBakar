...
class RegisterFormContent extends StatefulWidget {
  ...
  const RegisterFormContent({super.key, required this.onSwitchToLogin});
...
class _RegisterFormContentState extends State<RegisterFormContent> {
  ...
  /// Option A: Email, Password & Full Name Registration Flow (Steps 1 - 14)
    ...
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        if (mounted) {
          ...
          // Tampilkan Pesan Kesalahan (Step 15 - 16: Error / Fail)
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
      ...
      child: Form(
        ...
        child: Column(
          ...
          children: [
            ...
            // Option A: Full Name Field (ERD full_name)
            const Text(
              'Full Name',
              style: TextStyle(
                fontSize: 14,
            ...
            // Option A: Email Field (ERD email)
            const Text(
              'Email',
              style: TextStyle(
                fontSize: 14,
            ...
            // Option A: Password Field (ERD hashed_password)
            const Text(
              'Password',
              style: TextStyle(
                fontSize: 14,
            ...
            // Option A: Submit Button (POST /auth/register)
            _buildSubmitButton(),
            const SizedBox(height: 20),
...
class RegisterScreen extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const WelcomeScreen(initialMode: AuthMode.register);
  }
}
