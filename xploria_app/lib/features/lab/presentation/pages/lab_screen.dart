...
// v3 Phase 1: AI Lab tab dihapus. LabScreen sekarang hanya menampilkan IoT Lab.
// Widget AiLabContent dan ai_lab_content.dart tidak lagi digunakan.
                            ...
                            child: DropdownButtonHideUnderline(
                              child: DropdownButton<ProjectModel>(
                                ...
                                icon: const Icon(Icons.keyboard_arrow_down_rounded,
                                    color: Color(0xFF005CFF), size: 28),
                                itemHeight: 64,
                                focusColor: Colors.transparent,
                                        ...
                                        children: [
                                          ...
                                          if (isSelected)
                                            const Icon(Icons.check_circle_rounded,
                                                color: Color(0xFF005CFF), size: 20),
                                        ],
                                      ),
                                    ),
                                  );
              ...
              if (_selectedProject != null)
                ...
                const Center(
                  child: Padding(
                    ...
                    child: Text(
                      'Buat project terlebih dahulu untuk menggunakan IoT Lab.',
